...
namespace System.ComponentModel.DataAnnotations.Tests
{
    public class ValidatorTests
    {
        ...
        public class AsyncAlwaysFailsAttribute : AsyncValidationAttribute
        {
            ...
            {
                return new ValueTask<ValidationResult>(new ValidationResult("Async validation always fails"));
            }
        }
        ...
        public class AsyncClassAlwaysFailsAttribute : AsyncValidationAttribute
        {
            protected override ValueTask<ValidationResult> IsValidAsync(
                object value, ValidationContext validationContext, CancellationToken cancellationToken)
            {
                return new ValueTask<ValidationResult>(new ValidationResult("Async class validation failed"));
            }
        }
