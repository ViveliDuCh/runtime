...
namespace Microsoft.Extensions.Options
{
    ...
    public class AsyncValidateOptions<TOptions> : IAsyncValidateOptions<TOptions> where TOptions : class
    {
        ...
        public AsyncValidateOptions(string? name, Func<TOptions, CancellationToken, ValueTask<bool>> validation, string failureMessage)
        {
        ...
        public async ValueTask<ValidateOptionsResult> ValidateAsync(string? name, TOptions options, CancellationToken cancellationToken = default)
        {
            ...
            {
                if (await Validation.Invoke(options, cancellationToken).ConfigureAwait(false))
                {
    ...
    public class AsyncValidateOptions<TOptions, TDep> : IAsyncValidateOptions<TOptions> where TOptions : class
    {
        ...
        /// <param name="validation">Validation function.</param>
        /// <param name="failureMessage">Validation failure message.</param>
        public AsyncValidateOptions(string? name, TDep dependency, Func<TOptions, TDep, CancellationToken, ValueTask<bool>> validation, string failureMessage)
        {
            ArgumentNullException.ThrowIfNull(validation);
        ...
        public async ValueTask<ValidateOptionsResult> ValidateAsync(string? name, TOptions options, CancellationToken cancellationToken = default)
        {
            ...
            if (Name is null || name == Name)
            {
                if (await Validation.Invoke(options, Dependency, cancellationToken).ConfigureAwait(false))
                {
                    return ValidateOptionsResult.Success;
                }
    ...
    public class AsyncValidateOptions<TOptions, TDep1, TDep2> : IAsyncValidateOptions<TOptions> where TOptions : class
    {
        ...
        /// <param name="validation">Validation function.</param>
        /// <param name="failureMessage">Validation failure message.</param>
        public AsyncValidateOptions(string? name, TDep1 dependency1, TDep2 dependency2, Func<TOptions, TDep1, TDep2, CancellationToken, ValueTask<bool>> validation, string failureMessage)
        {
            ArgumentNullException.ThrowIfNull(validation);
        ...
        /// Gets the validation function.
        /// </summary>
        public Func<TOptions, TDep1, TDep2, CancellationToken, ValueTask<bool>> Validation { get; }
        ...
        public async ValueTask<ValidateOptionsResult> ValidateAsync(string? name, TOptions options, CancellationToken cancellationToken = default)
        {
            ...
            if (Name is null || name == Name)
            {
                if (await Validation.Invoke(options, Dependency1, Dependency2, cancellationToken).ConfigureAwait(false))
                {
                    return ValidateOptionsResult.Success;
                }
    ...
    public class AsyncValidateOptions<TOptions, TDep1, TDep2, TDep3> : IAsyncValidateOptions<TOptions> where TOptions : class
    {
        ...
        /// <param name="validation">Validation function.</param>
        /// <param name="failureMessage">Validation failure message.</param>
        public AsyncValidateOptions(string? name, TDep1 dependency1, TDep2 dependency2, TDep3 dependency3, Func<TOptions, TDep1, TDep2, TDep3, CancellationToken, ValueTask<bool>> validation, string failureMessage)
        {
            ArgumentNullException.ThrowIfNull(validation);
        ...
        /// Gets the validation function.
        /// </summary>
        public Func<TOptions, TDep1, TDep2, TDep3, CancellationToken, ValueTask<bool>> Validation { get; }
        ...
        public async ValueTask<ValidateOptionsResult> ValidateAsync(string? name, TOptions options, CancellationToken cancellationToken = default)
        {
            ...
            if (Name is null || name == Name)
            {
                if (await Validation.Invoke(options, Dependency1, Dependency2, Dependency3, cancellationToken).ConfigureAwait(false))
                {
                    return ValidateOptionsResult.Success;
                }
    ...
    public class AsyncValidateOptions<TOptions, TDep1, TDep2, TDep3, TDep4> : IAsyncValidateOptions<TOptions> where TOptions : class
    {
        ...
        /// <param name="validation">Validation function.</param>
        /// <param name="failureMessage">Validation failure message.</param>
        public AsyncValidateOptions(string? name, TDep1 dependency1, TDep2 dependency2, TDep3 dependency3, TDep4 dependency4, Func<TOptions, TDep1, TDep2, TDep3, TDep4, CancellationToken, ValueTask<bool>> validation, string failureMessage)
        {
            ArgumentNullException.ThrowIfNull(validation);
        ...
        /// Gets the validation function.
        /// </summary>
        public Func<TOptions, TDep1, TDep2, TDep3, TDep4, CancellationToken, ValueTask<bool>> Validation { get; }
        ...
        public async ValueTask<ValidateOptionsResult> ValidateAsync(string? name, TOptions options, CancellationToken cancellationToken = default)
        {
            ...
            if (Name is null || name == Name)
            {
                if (await Validation.Invoke(options, Dependency1, Dependency2, Dependency3, Dependency4, cancellationToken).ConfigureAwait(false))
                {
                    return ValidateOptionsResult.Success;
                }
    ...
    public class AsyncValidateOptions<TOptions, TDep1, TDep2, TDep3, TDep4, TDep5> : IAsyncValidateOptions<TOptions> where TOptions : class
    {
        ...
        /// <param name="validation">Validation function.</param>
        /// <param name="failureMessage">Validation failure message.</param>
        public AsyncValidateOptions(string? name, TDep1 dependency1, TDep2 dependency2, TDep3 dependency3, TDep4 dependency4, TDep5 dependency5, Func<TOptions, TDep1, TDep2, TDep3, TDep4, TDep5, CancellationToken, ValueTask<bool>> validation, string failureMessage)
        {
            ArgumentNullException.ThrowIfNull(validation);
        ...
        /// Gets the validation function.
        /// </summary>
        public Func<TOptions, TDep1, TDep2, TDep3, TDep4, TDep5, CancellationToken, ValueTask<bool>> Validation { get; }
        ...
        public async ValueTask<ValidateOptionsResult> ValidateAsync(string? name, TOptions options, CancellationToken cancellationToken = default)
        {
            ...
            if (Name is null || name == Name)
            {
                if (await Validation.Invoke(options, Dependency1, Dependency2, Dependency3, Dependency4, Dependency5, cancellationToken).ConfigureAwait(false))
                {
                    return ValidateOptionsResult.Success;
                }
